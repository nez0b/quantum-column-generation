"""PSP#1 — flash all 4 Dirac columns on the shared graph."""
...
class PSP1DiracFlashScene(Scene):
    def construct(self):
        psp = load_psp(PSP1_PATH)

        banner = Tex(
            r"\textbf{PSP \#1 --- Dirac-3 pricing columns}",
        ...
        flash_columns(
            ...
            dwell=1.2, hold=0.5, fade_time=0.3,
